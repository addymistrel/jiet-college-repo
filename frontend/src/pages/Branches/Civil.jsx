        ...
        <div className="child-11">
          ...
          >
            ...
            <Box textAlign="center">
              <Image
                src="/assets/images/imagesUpdated/civil.png"
                alt="branch-img"
                maxW="75%"
                mx="auto"
                borderRadius="2rem"
            ...
            <Text fontSize={{ base: "lg", md: "s" }} mb={6}>
              With urbanization and infrastructure development there has been
              urgent need for good designer and construction engineers. So,
              ...
              takes place in the public sector from municipal through to
              national governments, and in the private sector from individual
              home owners through to international companies.
            </Text>
            <Flex
